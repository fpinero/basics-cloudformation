...
stackName=github-oidc-provider-stack-$RANDOM

aws cloudformation create-stack --stack-name $stackName --template-body file://github-oidc-provider.yaml --capabilities CAPABILITY_NAMED_IAM
